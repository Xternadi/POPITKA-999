...
var Choosen;
class DannieDTKProg extends React.Component{
    constructor() {
        super()
        this.state = {
            Prog: []
    ...
    componentDidMount() {
        ...
        const ProgMeh = db.collection("Город").doc("Димитровград").collection("ДТК").doc("Специальность").collection("Программирование");
    ...
    return (
        <div>
          ...
          <NavLink to={"/dimitrovgrad/DTK/Prog/Choosen/"+item.id} onClick={this.knop =()=> {Choosen=item.id; console.log(Choosen)}}><div className="block">
