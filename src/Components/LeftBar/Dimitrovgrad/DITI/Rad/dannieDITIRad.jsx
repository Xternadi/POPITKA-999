...
var Choosen;
class DannieDITIRad extends React.Component{
    constructor() {
        super()
        this.state = {
            Rad: []
    ...
    return (
        <div>
          ...
          <NavLink to={"/dimitrovgrad/DITI/Rad/Choosen/"+item.id} onClick={this.knop =()=> {Choosen=item.id; console.log(Choosen)}}><div className="block">
